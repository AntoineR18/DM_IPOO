...
def test_Combinaison_initialisation_parametres(cartes, erreur, message_erreur):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Combinaison((pytest.neuf_trefle, pytest.huit_coeur, pytest.neuf_pique)), False)
    ]
)
...
@pytest.mark.parametrize(  # pas sure sure hein
    "combinaison, resultat_attendu",
    [
        (Combinaison((pytest.neuf_trefle, pytest.neuf_coeur, pytest.neuf_pique, pytest.neuf_carreau)), True),
        (Combinaison((pytest.neuf_trefle, pytest.huit_trefle, pytest.deux_pique)), False)
    ]
)
...
@pytest.mark.parametrize(  # pas sure sure hein
    "combinaison, resultat_attendu",
    [
        (Combinaison((pytest.deux_coeur, pytest.trois_coeur, pytest.quatre_coeur, pytest.cinq_coeur)), True),
        (Combinaison((pytest.neuf_trefle, pytest.huit_trefle)), False),
        (Combinaison((pytest.deux_coeur, pytest.trois_coeur, pytest.as_coeur, pytest.roi_coeur)), False),
    ]
)
...
@pytest.mark.parametrize(  # pas sure sure hein
    ...
    [
        ...
        # séquence
        (Combinaison((pytest.neuf_trefle, pytest.huit_trefle)), False),
        (Combinaison((pytest.neuf_trefle, pytest.neuf_coeur, pytest.neuf_pique)), True),  # brelan
    ]
)
...
@pytest.mark.parametrize(
    "combinaison, resultat_attendu",
    [
        (Combinaison((pytest.deux_coeur, pytest.trois_coeur, pytest.quatre_coeur, pytest.as_coeur)), 10),
        (Combinaison((pytest.as_trefle, pytest.as_coeur, pytest.as_pique, pytest.as_carreau)), 44),
        (Combinaison((pytest.deux_coeur, pytest.trois_coeur, pytest.quatre_coeur, pytest.cinq_coeur)), 14),
        (Combinaison((pytest.valet_pique, pytest.dame_pique, pytest.roi_pique, pytest.as_pique)), 41),
